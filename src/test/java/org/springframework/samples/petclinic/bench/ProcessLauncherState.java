...
public class ProcessLauncherState {
    ...
    protected String getClasspath() {
        ...
        Archive root = getRootArchive();
        List<Archive> resolved = resolver.resolve(root, name, profiles);
        StringBuilder builder = new StringBuilder(getAppClasspath());
        try {
    ...
    protected Archive getRootArchive() {
        return ArchiveUtils.getArchive(getClass());
    }

    protected String getAppClasspath() {
